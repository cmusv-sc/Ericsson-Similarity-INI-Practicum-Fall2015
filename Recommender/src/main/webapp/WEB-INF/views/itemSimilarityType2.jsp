...
<body>
	...
	<div class="container">
		...
		<div class="col-xs-6 col-lg-9">
		   <div class="row"><h2>Are these movies similar to ${selectedMovieTitle}?</h2></div>
		   ...
		   <div class="row">
			...
			<div id="movieFourth" class="col-xs-3 col-lg-3"></div></div>
			...
			<div id="movieEighth" class="col-xs-3 col-lg-3"></div></div>
			...
			<div id="movieTwelth" class="col-xs-3 col-lg-3"></div></div>
		   </div>
		   </div>
		</div>
